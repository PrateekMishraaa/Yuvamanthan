  ...
  <>
    <Router>
      <Routes>
        ...
        <Route path='/programs/nipam' element={<ProtectedRoutes>
          <Nipam/>
        </ProtectedRoutes>}/>
        <Route path='/program/cleanAir' element={<ProtectedRoutes>
          <AirQualityAwareness/>
        </ProtectedRoutes>}/>
        <Route path='/program/modelg20' element={<ProtectedRoutes>
          <ModelG20/>
        </ProtectedRoutes>}/>
