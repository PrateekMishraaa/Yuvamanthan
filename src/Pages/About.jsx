...
const About = () => {
  ...
  return (
    <>
      ...
      <section className="relative w-full px-4 sm:px-6 lg:px-24 py-16 md:py-28 bg-gradient-to-br from-[#6A3E2E] via-[#8B4513] to-[#E07B00] overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="bg-[#8B4513]/30 backdrop-blur-sm rounded-2xl p-6 border border-[#6A3E2E]/50 max-w-3xl">
              <FaQuoteLeft className="text-3xl text-[#FFD700] mb-4" />
      ...
      {/* MISSION SECTION - Updated with theme colors */}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <motion.div
              ...
              className="lg:w-1/2"
            >
              <h2 className="text-3xl sm:text-4xl font-bold text-[#6A3E2E] mb-6">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gradient-to-r from-[#FFF7ED] to-[#FFEDD5] rounded-xl p-6 border border-[#6A3E2E]/20">
                  <h3 className="font-bold text-[#6A3E2E] text-xl mb-4">Critical Skills Cultivated</h3>
                  <div className="grid grid-cols-2 gap-3">
                    {skills.map((skill, index) => (
                      <div key={index} className="flex items-center gap-2">
                        <FaStar className="text-[#FFA500] text-sm" />
                        <span className="text-[#6A3E2E]">{skill}</span>
                      </div>
                    ))}
                  </div>
                </div>
            ...
            <motion.div
              ...
              className="lg:w-1/2"
            >
              <div className="bg-gradient-to-br from-[#6A3E2E] to-[#8B4513] rounded-3xl p-8 text-white shadow-2xl">
                <h3 className="text-2xl font-bold mb-6">Our Impact in Numbers</h3>
                <div className="grid grid-cols-2 gap-6">
                  {stats.map((stat, index) => (
                    <div key={index} className="text-center">
                      <div className={`inline-flex p-3 rounded-xl bg-gradient-to-r ${stat.gradient} mb-3`}>
                        {stat.icon}
                      </div>
      ...
      {/* PROGRAMS SECTION - Updated with theme colors */}
      <section className="py-20 px-4 sm:px-6 lg:px-24 bg-gradient-to-b from-[#FFF7ED] to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-[#8B4513]/80 max-w-3xl mx-auto text-lg">
              ...
              >
                <div className="bg-white rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 h-full border border-[#6A3E2E]/10">
                  ...
                  <div className="p-6">
                    ...
                    <Link to={''}>
                      <button className="w-full border-2 border-[#6A3E2E] text-[#6A3E2E] py-3 rounded-lg font-semibold hover:bg-[#FFF7ED] transition-colors flex items-center justify-center gap-2">
                        Explore more
      ...
      {/* TESTIMONIALS SECTION - Updated with theme colors */}
      <section className="py-20 px-4 sm:px-6 lg:px-24 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-[#6A3E2E] mb-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
            {testimonials.map((testimonial, index) => (
              ...
              >
                <div className={`bg-gradient-to-br from-white to-[#FFF7ED] rounded-2xl p-6 h-full border-2 ${
                  expandedTestimonial === index 
                    ? 'border-[#8B4513] shadow-xl' 
                    : 'border-[#6A3E2E]/20 shadow-lg hover:shadow-xl'
                }`}>
                  <FaQuoteLeft className="text-3xl text-[#8B4513] mb-4" />
                  <p className="text-[#8B4513] mb-6 leading-relaxed">
                    {expandedTestimonial === index 
                      ? testimonial.quote 
                  ...
                  <div className="border-t border-[#6A3E2E]/20 pt-4">
                    <p className="font-bold text-[#6A3E2E]">{testimonial.name}</p>
                    <p className="text-[#8B4513]">{testimonial.position}</p>
                    <p className="text-[#8B4513]/80 text-sm">{testimonial.institution}</p>
                  </div>
                </div>
              </motion.div>
            ))}
          ...
          <div className="text-center">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[#FFF7ED] to-[#FFEDD5] border border-[#FFA500] rounded-full px-6 py-3">
              <FaAward className="text-[#FFA500]" />
              <span className="text-[#6A3E2E] font-semibold">
