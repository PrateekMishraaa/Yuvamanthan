      ...
      <section className='flex-1 w-full p-3 sm:p-4 md:p-5 lg:p-6 overflow-x-hidden'>
        <div className='h-auto w-full bg-white rounded-xl sm:rounded-2xl shadow-lg border border-[#8B4513]/10 overflow-hidden'>
          ...
          <div className='flex flex-col sm:flex-row justify-between items-start gap-4 border-b border-[#8B4513]/10 p-4 sm:p-5 md:p-6'>
            <div>
              <h1 className='text-2xl sm:text-3xl md:text-4xl font-bold text-[#6A3E2E]'>About Institution</h1>
          ...
          <div className='w-full p-4 sm:p-5 md:p-6'>
            ...
            <div className='mb-5 sm:mb-6 md:mb-8'>
              <label className='block mb-2 font-semibold text-[#6A3E2E] text-sm sm:text-base'>
              ...
              <input
                ...
                className='w-full md:w-3/4 lg:w-1/2 py-2.5 sm:py-3 px-3 sm:px-4 border border-[#8B4513]/30 rounded-lg bg-[#FFF7ED]/30 
                           focus:border-[#FF8C00] focus:ring-2 focus:ring-[#FF8C00]/20 outline-none
                           placeholder:text-[#8B4513]/40 text-[#6A3E2E] text-sm sm:text-base'
              />
            ...
            <div className='mb-5 sm:mb-6 md:mb-8'>
              ...
              <textarea
                ...
                maxLength="500"
                className='w-full md:w-5/6 py-2.5 sm:py-3 px-3 sm:px-4 border border-[#8B4513]/30 rounded-lg bg-[#FFF7ED]/30 
                           focus:border-[#FF8C00] focus:ring-2 focus:ring-[#FF8C00]/20 outline-none 
                           resize-none placeholder:text-[#8B4513]/40 text-[#6A3E2E] text-sm sm:text-base'
              />

              <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 mt-2'>
                <p className='text-xs sm:text-sm text-[#8B4513]/60'>
