        ...
        <section className='flex-1 w-full p-3 sm:p-4 md:p-5 lg:p-6 overflow-x-hidden'>
          <div className='h-auto w-full bg-white rounded-xl sm:rounded-2xl shadow-lg border border-[#8B4513]/10 overflow-hidden'>
            ...
            <div className='flex flex-col sm:flex-row justify-between items-start gap-4 border-b border-[#8B4513]/10 p-4 sm:p-5 md:p-6'>
              <div>
                <h1 className='text-2xl sm:text-3xl md:text-4xl font-bold text-[#6A3E2E]'>Institute Registered Address</h1>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 md:gap-6'>
                ...
                <div className='space-y-1 sm:space-y-2'>
                  <label className='block'>
                    <span className='font-semibold text-[#6A3E2E] text-sm sm:text-base'>Country</span>
                ...
                <div className='space-y-1 sm:space-y-2'>
                  <label className='block'>
                    <span className='font-semibold text-[#6A3E2E] text-sm sm:text-base'>State</span>
                    <span className='text-red-500 ml-1'>*</span>
                  </label>
                  <select
                ...
                <div className='space-y-1 sm:space-y-2'>
                  <label className='block'>
                    <span className='font-semibold text-[#6A3E2E] text-sm sm:text-base'>District</span>
                    <span className='text-red-500 ml-1'>*</span>
                  </label>
                  <input
                    type="text"
                ...
                <div className='space-y-1 sm:space-y-2'>
                  <label className='block'>
                    <span className='font-semibold text-[#6A3E2E] text-sm sm:text-base'>City</span>
                    <span className='text-red-500 ml-1'>*</span>
                  </label>
                  {cities.length > 0 ? (
                    <select
                ...
                <div className='md:col-span-2 space-y-1 sm:space-y-2'>
                  <label className='block'>
                    <span className='font-semibold text-[#6A3E2E] text-sm sm:text-base'>Street Address</span>
                    <span className='text-red-500 ml-1'>*</span>
                  </label>
                  <textarea
                    rows="3"
                ...
                <div className='space-y-1 sm:space-y-2'>
                  <label className='block'>
                    <span className='font-semibold text-[#6A3E2E] text-sm sm:text-base'>Pincode</span>
                    <span className='text-red-500 ml-1'>*</span>
                  </label>
                  <input
                    type="text"
                    ...
                    maxLength="6"
                    className='w-full md:w-2/3 py-2.5 sm:py-3 px-3 sm:px-4 border border-[#8B4513]/30 rounded-lg bg-[#FFF7ED]/30 
                             focus:border-[#FF8C00] focus:ring-2 focus:ring-[#FF8C00]/20 outline-none 
                             transition-all duration-300 placeholder:text-[#8B4513]/40 text-[#6A3E2E] text-sm sm:text-base'
                  />
                  <p className='text-xs text-[#8B4513]/60 mt-2'>
