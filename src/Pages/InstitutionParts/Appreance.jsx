        ...
        <section className='h-auto w-full bg-gradient-to-br from-[#FFF7ED] to-[#FFEDD5] p-4'>
          <div className='h-auto w-full bg-white rounded-2xl shadow-lg p-6 border border-[#8B4513]/10'>
            ...
            <div className='flex justify-between items-start border-b border-[#8B4513]/10 pb-4 mb-6'>
              <div>
                <h1 className='text-3xl font-bold text-[#6A3E2E]'>Institute Appearance</h1>
            ...
            <div className='w-full px-4'>
              ...
              <div className='mb-10'>
                <div className='flex items-center justify-between mb-4'>
                  <div>
                    <h2 className='text-xl font-semibold text-[#6A3E2E]'>Institute Logo</h2>
                    <p className='text-sm text-[#8B4513]/60 mt-1'>
                      Upload your institute's logo. Recommended size: 200x200px (PNG, JPG, SVG)
                    </p>
                  </div>
                ...
                <div className='flex flex-col md:flex-row items-start md:items-center gap-8'>
                  ...
                  <div className='flex-shrink-0'>
                    <div className='w-40 h-40 rounded-2xl border-2 border-dashed border-[#8B4513]/30 bg-gradient-to-br from-[#FFF7ED] to-[#FFEDD5] flex items-center justify-center overflow-hidden'>
                      <div className='text-center p-4'>
                        <svg className='w-12 h-12 mx-auto text-[#8B4513]/40' fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                        <p className='text-xs text-[#8B4513]/50 mt-2'>Logo Preview</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className='flex-grow space-y-4'>
                    <div className='flex flex-col sm:flex-row gap-4'>
                      ...
                      <button className='px-6 py-3 border-2 border-red-500 text-red-500 rounded-lg font-semibold hover:bg-red-50 transition-all duration-300 flex items-center gap-2'>
                        <svg className='w-5 h-5' fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className='mb-10'>
                <div className='flex items-center justify-between mb-4'>
                  <div>
                    <h2 className='text-xl font-semibold text-[#6A3E2E]'>Website URL</h2>
                    <p className='text-sm text-[#8B4513]/60 mt-1'>
