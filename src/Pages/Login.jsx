        ...
        <div className="w-full max-w-lg mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mt-6 sm:mt-8">
            <div className="bg-white rounded-lg sm:rounded-xl p-3 sm:p-4 border border-[#6A3E2E]/10 text-center hover:shadow-md transition-shadow">
              ...
              <div className="text-[10px] sm:text-xs text-[#8B4513]/80">Active Users</div>
            </div>
            <div className="bg-white rounded-lg sm:rounded-xl p-3 sm:p-4 border border-[#6A3E2E]/10 text-center hover:shadow-md transition-shadow">
              <div className="text-lg sm:text-xl md:text-2xl font-bold text-[#6A3E2E]">10K+</div>
              <div className="text-[10px] sm:text-xs text-[#8B4513]/80">Events Conducted</div>
            </div>
            <div className="bg-white rounded-lg sm:rounded-xl p-3 sm:p-4 border border-[#6A3E2E]/10 text-center hover:shadow-md transition-shadow">
              <div className="text-lg sm:text-xl md:text-2xl font-bold text-[#6A3E2E]">450+</div>
              <div className="text-[10px] sm:text-xs text-[#8B4513]/80">Expert Mentors</div>
            </div>
          </div>
        </div>
      </section>
