...
const YuvamanthanUnitedNations = () => {
  ...
  const eventSchedule = [
    { time: "9:00 a.m.", activity: "Rolecall", icon: <Clock4 className="w-5 h-5" /> },
    { time: "9:30 a.m.", activity: "Session 1", icon: <MessageSquare className="w-5 h-5" /> },
    { time: "11:45 a.m.", activity: "Break (15 mins)", icon: <Coffee className="w-5 h-5" /> },
    { time: "12:00 p.m.", activity: "Session 2", icon: <Users2 className="w-5 h-5" /> },
    { time: "1:30 p.m.", activity: "Lunch (30 mins)", icon: <Utensils className="w-5 h-5" /> },
    { time: "2:00 p.m.", activity: "Session 3", icon: <FileText className="w-5 h-5" /> },
    { time: "3:30 p.m.", activity: "Final speeches and document drafting", icon: <Award className="w-5 h-5" /> }
  ];

  const committees = [
    { name: "Security Council", icon: <Shield className="w-6 h-6" /> },
    { name: "General Assembly", icon: <Globe className="w-6 h-6" /> },
    { name: "Economic and Social Council", icon: <BarChart3 className="w-6 h-6" /> },
    { name: "All India Political Party Meeting", icon: <Building2 className="w-6 h-6" /> },
    { name: "Economic and Finance Committee", icon: <DollarSign className="w-6 h-6" /> },
    { name: "International Court of Justice", icon: <Scale className="w-6 h-6" /> }
  ];

  const pressCorpsRoles = [
    { role: "Journalist", icon: <Newspaper className="w-5 h-5" /> },
    { role: "Photographer", icon: <Camera className="w-5 h-5" /> },
    { role: "Caricaturist", icon: <Palette className="w-5 h-5" /> }
  ];

  const executiveBoardRoles = [
    { role: "Chairperson", icon: <Gavel className="w-5 h-5" /> },
    { role: "Vice-Chairperson", icon: <Users className="w-5 h-5" /> },
    { role: "Rapporteur", icon: <FileText className="w-5 h-5" /> },
    { role: "Judges", icon: <Scale className="w-5 h-5" /> }
  ];

  const markingScheme = [
    { rank: "1st Place", title: "Best Delegate", icon: <TrophyIcon className="w-6 h-6" /> },
    { rank: "2nd Place", title: "High Commendation", icon: <Medal className="w-6 h-6" /> },
    { rank: "3rd Place", title: "Merit", icon: <AwardIcon className="w-6 h-6" /> }
  ];
    ...
    <>
            ...
            <div className="w-full lg:w-1/2 space-y-8">
              <div className="space-y-6">
                <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-amber-100 to-orange-100 rounded-full">
                  <Globe className="w-5 h-5 text-[#8B4513] mr-2" />
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <button 
                  ...
                  className="group relative h-14 w-full sm:w-48 px-8 overflow-hidden rounded-xl bg-gradient-to-r from-[#6A3E2E] via-[#8B4513] to-[#E07B00] text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02]"
                >
                ...
                <button className="group relative h-14 w-full sm:w-48 px-8 overflow-hidden rounded-xl border-2 border-gray-300 text-gray-700 shadow-sm hover:shadow-lg transition-all duration-300 hover:bg-gray-50">
                  <div className="relative flex items-center justify-center space-x-3">
              ...
              <div className="relative group">
                ...
                <div className="relative bg-white rounded-2xl p-8 shadow-2xl transform group-hover:-translate-y-2 transition-transform duration-300 overflow-hidden">
                  <div className="text-center space-y-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-gray-900">Event Features</h3>
                      <p className="text-gray-600 mt-2">Experience Everything</p>
                    </div>
                    
                    <div className="grid grid-cols-2 gap-4">
                      {programFeatures.slice(0, 4).map((feature, index) => (
                        <div key={index} className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl p-4 border border-orange-200 shadow-sm hover:shadow-md transition-all duration-300">
                          <div className="w-10 h-10 rounded-lg bg-gradient-to-r from-[#6A3E2E] to-[#8B4513] flex items-center justify-center mb-3 shadow-md">
                            <div className="text-white">
                              {feature.icon}
                            </div>
                          </div>
                          <h4 className="font-semibold text-[#8B4513] text-sm">{feature.title}</h4>
                        </div>
                      ))}
                    </div>
                  </div>
        ...
        <div className="container mx-auto px-4 md:px-8 lg:px-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-2xl p-6 border border-orange-200 shadow-lg hover:shadow-xl transition-all duration-300">
                <h3 className="text-xl font-bold text-[#8B4513] mb-4">Beyond Traditional Committees</h3>
            ...
            <div className="relative group">
              ...
              <div className="relative overflow-hidden rounded-2xl shadow-2xl">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                  <h3 className="text-xl font-bold">Immersive Engagement</h3>
                  <p className="text-orange-100">Active debates and collaborative discussions</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {programFeatures.map((feature, index) => (
              <div key={index} className="group relative">
                ...
                <div className="relative bg-white rounded-2xl p-8 shadow-xl transform group-hover:-translate-y-2 transition-all duration-300 h-full border border-orange-200">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <div className="space-y-8">
                <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-2xl p-6 border border-orange-200 shadow-lg hover:shadow-xl transition-all duration-300">
                  <h3 className="text-2xl font-bold text-[#8B4513] mb-4">Diverse UN Committees</h3>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {committees.slice(0, 4).map((committee, index) => (
                      <div key={index} className="flex items-center p-3 bg-white rounded-lg border border-orange-200 shadow-sm hover:shadow-md transition-all duration-300">
                        <div className="w-10 h-10 rounded-lg bg-gradient-to-r from-[#8B4513] to-[#C46200] flex items-center justify-center mr-3 shadow-md">
                          <div className="text-white">
                            {committee.icon}
                          </div>
                        </div>
                        <span className="font-medium text-gray-800">{committee.name}</span>
                      </div>
                    ))}
                  </div>
                </div>

                <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl p-6 border border-amber-200 shadow-lg hover:shadow-xl transition-all duration-300">
                  <h3 className="text-2xl font-bold text-[#C46200] mb-4">Tackling Global Issues</h3>
                  <p className="text-gray-700">
            ...
            <div className="space-y-8">
              <div className="relative group">
                ...
                <div className="relative bg-white rounded-2xl p-8 shadow-xl border border-orange-200">
                  <h3 className="text-2xl font-bold text-gray-900 mb-6">Special Committees</h3>
                  
                  <div className="space-y-6">
                    <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl p-5 border border-orange-200 shadow-sm hover:shadow-md transition-all duration-300">
                      <div className="flex items-center mb-3">
                        <div className="w-12 h-12 rounded-lg bg-gradient-to-r from-[#E07B00] to-[#FFA500] flex items-center justify-center mr-4 shadow-md">
                          <DollarSign className="w-6 h-6 text-white" />
                        </div>
                        <div>
                          <h4 className="font-bold text-gray-900">Economic and Finance Committee</h4>
                          <p className="text-sm text-gray-600">Unique perspective on global economic challenges</p>
                        </div>
                      </div>
                    </div>

                    <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl p-5 border border-amber-200 shadow-sm hover:shadow-md transition-all duration-300">
                      <div className="flex items-center mb-3">
                        <div className="w-12 h-12 rounded-lg bg-gradient-to-r from-[#FFA500] to-[#FF8C00] flex items-center justify-center mr-4 shadow-md">
                          <Sparkles className="w-6 h-6 text-white" />
                        </div>
                        <div>
                          <h4 className="font-bold text-gray-900">Special Committee</h4>
                          <p className="text-sm text-gray-600">Mandated by the General Assembly for comprehensive learning</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl p-5 border border-orange-200 shadow-sm hover:shadow-md transition-all duration-300">
                      <div className="flex items-center mb-3">
                        <div className="w-12 h-12 rounded-lg bg-gradient-to-r from-[#C46200] to-[#E07B00] flex items-center justify-center mr-4 shadow-md">
                          <History className="w-6 h-6 text-white" />
                        </div>
                        <div>
                          <h4 className="font-bold text-gray-900">Historical Reconstructions</h4>
                          <p className="text-sm text-gray-600">Reenacting momentous events and ICJ simulations</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white rounded-2xl p-6 shadow-lg border border-orange-200">
                  <h4 className="font-bold text-gray-900 mb-4">PRESS CORPS</h4>
                  <div className="space-y-3">
                    {pressCorpsRoles.map((role, index) => (
                      <div key={index} className="flex items-center p-3 bg-gradient-to-r from-orange-50 to-amber-50 rounded-lg border border-orange-200 shadow-sm hover:shadow-md transition-all duration-300">
                        <div className="w-8 h-8 rounded-md bg-gradient-to-r from-[#8B4513] to-[#C46200] flex items-center justify-center mr-3 shadow-sm">
                          <div className="text-white">
                            {role.icon}
                          </div>
                        </div>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg border border-amber-200">
                  <h4 className="font-bold text-gray-900 mb-4">EXECUTIVE BOARD</h4>
                  <div className="space-y-3">
                    {executiveBoardRoles.map((role, index) => (
                      <div key={index} className="flex items-center p-3 bg-gradient-to-r from-amber-50 to-orange-50 rounded-lg border border-amber-200 shadow-sm hover:shadow-md transition-all duration-300">
                        <div className="w-8 h-8 rounded-md bg-gradient-to-r from-[#C46200] to-[#E07B00] flex items-center justify-center mr-3 shadow-sm">
                          <div className="text-white">
                            {role.icon}
                          </div>
                        </div>
      ...
      <section className="py-20 bg-gradient-to-b from-orange-50 to-amber-50">
        <div className="container mx-auto px-4 md:px-8 lg:px-16">
          ...
          <div className="relative">
            {/* Timeline Line */}
            <div className="absolute left-0 lg:left-1/2 lg:-translate-x-1/2 h-full w-1 bg-gradient-to-b from-[#6A3E2E] via-[#8B4513] to-[#FF8C00] hidden lg:block"></div>
            
            <div className="space-y-8 lg:space-y-12">
              {programSteps.map((step, index) => (
                <div key={index} className={`relative flex flex-col ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-center gap-8`}>
                      ...
                      <div className="relative bg-white rounded-2xl p-8 shadow-xl border border-orange-200">
                        <div className="flex items-center mb-6">
                          <div className={`w-16 h-16 rounded-xl bg-gradient-to-r ${
                            ...
                            index === 4 ? 'from-[#FFA500] to-[#FF8C00]' :
                            'from-[#FF8C00] to-[#FF7F00]'
                          } flex items-center justify-center mr-6 shadow-lg`}>
                            <div className="text-white">
                              {step.icon}
                            </div>
                          </div>
        ...
        <div className="container mx-auto px-4 md:px-8 lg:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-6">
                <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-2xl p-6 border border-orange-200 shadow-lg hover:shadow-xl transition-all duration-300">
                  <h3 className="text-2xl font-bold text-[#8B4513] mb-4">Research & Preparation</h3>
                  <p className="text-gray-700 mb-4">
                ...
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-200 shadow-lg hover:shadow-xl transition-all duration-300">
                  <h3 className="text-2xl font-bold text-green-800 mb-4">Mission LiFE Integration</h3>
                  <p className="text-gray-700">
            ...
            <div className="relative group">
              <div className="absolute -inset-4 bg-gradient-to-r from-[#8B4513] to-[#E07B00] rounded-3xl blur-xl opacity-20 group-hover:opacity-30 transition-opacity duration-300"></div>
              <div className="relative bg-white rounded-2xl p-8 shadow-xl border border-orange-200">
                <h3 className="text-2xl font-bold text-gray-900 mb-6">Discussion Board Technology</h3>
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="bg-gradient-to-r from-orange-50 to-amber-50 p-3 rounded-lg mr-4 shadow-sm">
                      <Laptop className="w-6 h-6 text-[#8B4513]" />
                    </div>
                    <div>
                      <h4 className="font-bold text-gray-900 mb-1">Unique Tech Functionality</h4>
                      <p className="text-gray-600">Enables Teacher Coordinators to organise live real-time meetings between participating students.</p>
                    </div>
                  </div>
                  
                  <div className="flex items-start">
                    <div className="bg-gradient-to-r from-amber-50 to-orange-50 p-3 rounded-lg mr-4 shadow-sm">
                      <MessageSquareText className="w-6 h-6 text-[#C46200]" />
                    </div>
                    <div>
                      <h4 className="font-bold text-gray-900 mb-1">Interactive Discussions</h4>
                      <p className="text-gray-600">Students can write views, add points (restricted to 4), and vote on others' points.</p>
                    </div>
                  </div>
                  
                  <div className="flex items-start">
                    <div className="bg-gradient-to-r from-orange-50 to-amber-50 p-3 rounded-lg mr-4 shadow-sm">
                      <Network className="w-6 h-6 text-[#E07B00]" />
                    </div>
                    <div>
                      <h4 className="font-bold text-gray-900 mb-1">Automatic Leaderboards</h4>
                      <p className="text-gray-600">Leaderboards are created automatically once points have been voted upon.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900 mb-1">Student-Driven Discussions</h4>
                      <p className="text-gray-600">Students can create their own discussion boards and invite fellow delegates.</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 md:px-8 lg:px-16">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-2xl p-8 shadow-xl border border-orange-200">
              <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center">EVENT SCHEDULE</h3>
              ...
              <div className="space-y-4">
                {eventSchedule.map((item, index) => (
                  <div key={index} className={`flex items-center p-4 rounded-xl ${
                    ...
                    <div className="w-10 h-10 rounded-lg bg-white border border-orange-200 flex items-center justify-center mr-4 shadow-sm">
                      {item.icon}
                    </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-8 lg:px-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-2xl p-8 border border-orange-200 shadow-lg hover:shadow-xl transition-all duration-300 mb-8">
                <h3 className="text-2xl font-bold text-[#8B4513] mb-6">Judging Criteria</h3>
                <div className="space-y-4">
                  <div className="flex items-center p-4 bg-white rounded-xl border border-orange-200 shadow-sm hover:shadow-md transition-all duration-300">
                    <FileCheck className="w-6 h-6 text-[#8B4513] mr-4" />
                    <div>
                      <h4 className="font-bold text-gray-900">Scoresheet Evaluation</h4>
                      <p className="text-gray-600">Judges will use the scoresheet as provided in the Judges and Jury section</p>
                    </div>
                  </div>
                  
                  <div className="flex items-center p-4 bg-white rounded-xl border border-orange-200 shadow-sm hover:shadow-md transition-all duration-300">
                    <Star className="w-6 h-6 text-[#E07B00] mr-4" />
                    <div>
                      <h4 className="font-bold text-gray-900">Extra Recognition</h4>
                      <p className="text-gray-600">Extra marks to the Main Author of the Draft Resolution</p>
                    </div>
                  </div>
                </div>
              </div>

              <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl p-8 border border-amber-200 shadow-lg hover:shadow-xl transition-all duration-300">
                <h3 className="text-2xl font-bold text-[#C46200] mb-6">Award Categories</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {markingScheme.map((award, index) => (
                    <div key={index} className="text-center">
                      ...
                      <div className="font-bold text-gray-900">{award.rank}</div>
            ...
            <div>
              <div className="relative group h-full">
                ...
                <div className="relative bg-gradient-to-br from-[#8B4513] to-[#E07B00] rounded-2xl p-8 shadow-2xl h-full">
                  <div className="text-white">
                    <h3 className="text-2xl font-bold mb-6">Discussion Board</h3>
                    
                    <div className="space-y-6">
                      <div className="bg-white/10 rounded-xl p-6 backdrop-blur-sm shadow-inner">
                      ...
                      <div className="space-y-4">
                        <div className="flex items-start">
                          <div className="bg-white/20 p-3 rounded-lg mr-4 shadow-sm">
                            <MessageSquareText className="w-5 h-5 text-white" />
                          </div>
                          <div>
                            <h4 className="font-bold mb-1">Point Submission & Voting</h4>
                        ...
                        <div className="flex items-start">
                          ...
                          <div>
                            <h4 className="font-bold mb-1">Automatic Leaderboards</h4>
                            <p className="text-orange-100 text-sm">
                        ...
                        <div className="flex items-start">
                          ...
                          <div>
                            <h4 className="font-bold mb-1">Student-Led Discussions</h4>
                            <p className="text-orange-100 text-sm">
