...
const YuuthCommunity = () => {
  ...
  return (
    <>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
            ...
            <div className="w-full lg:w-1/2 space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl md:text-2xl text-[#8B4513]">
              ...
              <div className="grid grid-cols-2 gap-4">
                {coreValues.map((value, index) => (
                  <div
                    key={index}
                    className="group flex items-start space-x-4 p-4 bg-white/80 backdrop-blur-sm rounded-2xl border border-[#6A3E2E]/10 hover:shadow-lg transition-all duration-300"
                  >
                    ...
                    <div>
                      <h3 className="font-bold text-[#6A3E2E]">{value.title}</h3>
                      <p className="text-sm text-[#8B4513]/80 mt-1">{value.description}</p>
                    </div>
                  </div>
                ))}
              </div>
              ...
              {/* Description */}
              <div className="space-y-4 bg-white/60 backdrop-blur-sm rounded-3xl p-6 border border-[#8B4513]/10">
            ...
            <div className="w-full lg:w-1/2 relative">
              <div className="relative group">
                ...
                <div className="relative bg-white rounded-2xl p-4 shadow-2xl transform group-hover:-translate-y-2 transition-transform duration-300">
                  <div className="w-full h-64 md:h-96 rounded-xl bg-gradient-to-br from-[#6A3E2E]/20 to-[#E07B00]/20 flex items-center justify-center">
                    <div className="text-center p-8">
                      <Globe className="w-24 h-24 text-[#8B4513]/50 mx-auto mb-4" />
                      <p className="text-[#8B4513] font-semibold">Youth Community Platform</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="w-full bg-gradient-to-b from-white to-[#FFF7ED] py-12 md:py-20 lg:py-32">
        <div className="container mx-auto px-4 md:px-8 lg:px-16">
          <div className="text-center mb-12 lg:mb-16">
            <div className="inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-[#6A3E2E]/10 to-[#8B4513]/10 rounded-2xl mb-4 md:mb-6">
                ...
                <div className="relative p-6 md:p-8">
                  <div className="flex items-start justify-between mb-6">
                    <div className="p-3 bg-white rounded-xl shadow-md">
                      <div className={`text-${offering.borderColor.split('-')[1]?.split('/')[0] || '[#6A3E2E]'}`}>{offering.icon}</div>
                    </div>
                    <div className="text-5xl font-bold text-[#8B4513]/20">0{index + 1}</div>
                  </div>

                  <h3 className="text-xl md:text-2xl font-bold text-[#6A3E2E] mb-3">
                    {offering.title}
                  </h3>
                  <p className="text-[#8B4513]/80 text-sm md:text-base leading-relaxed">
                    {offering.description}
                  </p>

                  <button className="mt-6 flex items-center text-sm font-semibold text-[#6A3E2E] hover:text-[#8B4513] group">
        ...
        <div className="container mx-auto px-4 md:px-8 lg:px-16">
          <div className="text-center mb-12 lg:mb-16">
            <div className="inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-[#8B4513]/10 to-[#C46200]/10 rounded-2xl mb-4 md:mb-6">
              <TrendingUp className="w-8 h-8 md:w-10 md:h-10 text-[#8B4513]" />
            </div>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#6A3E2E] mb-4">
              Trending{" "}
              <span className="bg-gradient-to-r from-[#6A3E2E] via-[#8B4513] to-[#E07B00] bg-clip-text text-transparent">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="relative">
              <button
                ...
                className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 z-10 w-10 h-10 rounded-full bg-white shadow-xl border border-[#6A3E2E]/20 flex items-center justify-center hover:bg-[#FFF7ED] hover:scale-110 transition-all duration-300"
              >
                <ChevronLeft className="w-5 h-5 text-[#6A3E2E]" />
              </button>

              <button
                onClick={() => setActiveTopic((prev) => (prev + 1) % trendingTopics.length)}
                className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 z-10 w-10 h-10 rounded-full bg-white shadow-xl border border-[#6A3E2E]/20 flex items-center justify-center hover:bg-[#FFF7ED] hover:scale-110 transition-all duration-300"
              >
                <ChevronRight className="w-5 h-5 text-[#6A3E2E]" />
              </button>

              {/* Main Topic Display */}
              <div className="relative overflow-hidden rounded-3xl bg-white shadow-2xl border border-[#6A3E2E]/20">
                <div className="flex flex-col lg:flex-row">
                  ...
                  <div className="lg:w-2/5 relative">
                    ...
                    <div className="absolute bottom-4 left-4">
                      <div className="px-3 py-1 bg-white/90 backdrop-blur-sm rounded-full">
                        <span className="text-sm font-semibold text-[#6A3E2E]">Hot Topic</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="lg:w-3/5 p-6 md:p-8 lg:p-12">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-2xl md:text-3xl font-bold text-[#6A3E2E]">
                        {trendingTopics[activeTopic].title}
                      </h3>
                    </div>

                    <div className="mb-6">
                      <div className="inline-flex items-center px-3 py-1 bg-gradient-to-r from-[#6A3E2E]/10 to-[#8B4513]/10 rounded-full mb-4">
                        <div className="w-2 h-2 bg-gradient-to-r from-[#6A3E2E] to-[#8B4513] rounded-full mr-2 animate-pulse"></div>
                        <span className="text-sm font-semibold text-[#6A3E2E]">
                    ...
                    <div className="flex items-center justify-between">
                      <button className="px-6 py-3 bg-gradient-to-r from-[#6A3E2E] to-[#8B4513] text-white rounded-lg font-semibold hover:shadow-lg transition-all duration-300">
                        Join Discussion
                      </button>
              ...
              {trendingTopics.map((topic, index) => (
                ...
                >
                  <div className="flex items-center mb-4">
                    ...
                    <h4 className="font-bold text-[#6A3E2E]">{topic.title}</h4>
                  </div>
                  <p className="text-sm text-[#8B4513]/80 line-clamp-2">{topic.description}</p>
                  <div className="mt-4 flex items-center text-xs text-[#8B4513]/60">
      ...
      {/* Key Initiatives Section - Updated */}
      <section className="w-full bg-gradient-to-b from-white to-[#FFF7ED] py-12 md:py-20 lg:py-32">
        <div className="container mx-auto px-4 md:px-8 lg:px-16">
          <div className="text-center mb-12 lg:mb-16">
            <div className="inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-[#C46200]/10 to-[#E07B00]/10 rounded-2xl mb-4 md:mb-6">
              <Rocket className="w-8 h-8 md:w-10 md:h-10 text-[#C46200]" />
            </div>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#6A3E2E] mb-4">
              National{" "}
              <span className="bg-gradient-to-r from-[#6A3E2E] via-[#8B4513] to-[#E07B00] bg-clip-text text-transparent">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            {keyInitiatives.map((initiative, index) => (
              <div
                key={index}
                className="group relative overflow-hidden rounded-2xl md:rounded-3xl bg-white border border-[#6A3E2E]/20 shadow-lg hover:shadow-xl transition-all duration-300"
              >
                <div className="relative p-6 md:p-8">
                  <div className="flex items-start justify-between mb-6">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <h3 className="text-xl md:text-2xl font-bold text-[#6A3E2E]">
                          {initiative.title}
                        </h3>
                        <div className="inline-flex items-center px-2 py-1 bg-gradient-to-r from-[#6A3E2E]/10 to-[#8B4513]/10 rounded-full mt-2">
                  ...
                  <p className="text-[#8B4513]/80 text-sm md:text-base leading-relaxed mb-6">
                    {initiative.description}
                  </p>

                  <div className="flex items-center justify-between pt-4 border-t border-[#8B4513]/10">
                    <button className="flex items-center text-sm font-semibold text-[#6A3E2E] hover:text-[#8B4513]">
                      <span>Learn More</span>
                      <ArrowRight className="w-4 h-4 ml-1" />
                    </button>
                    <div className="text-xs text-[#8B4513]/60">Govt. Initiative</div>
                  </div>
                </div>
              </div>
            ))}
      ...
      {/* Youth Gallery Section - Updated */}
      <section className="w-full bg-gradient-to-b from-[#FFF7ED] to-white py-12 md:py-20 lg:py-32">
        <div className="container mx-auto px-4 md:px-8 lg:px-16">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
            <div className="w-full lg:w-1/2">
              <div className="relative group">
                <div className="absolute -inset-4 bg-gradient-to-r from-[#E07B00] via-[#8B4513] to-[#6A3E2E] rounded-3xl blur-xl opacity-20 group-hover:opacity-30 transition-opacity duration-300"></div>
                <div className="relative bg-white rounded-2xl p-4 shadow-2xl transform group-hover:-translate-y-2 transition-transform duration-300">
                  <div className="w-full h-64 md:h-96 rounded-xl bg-gradient-to-br from-[#8B4513]/20 to-[#FFA500]/20 flex items-center justify-center">
                    <div className="text-center p-8">
                      <Users className="w-24 h-24 text-[#8B4513]/50 mx-auto mb-4" />
                      <p className="text-[#8B4513] font-semibold">Showcase Your Talent</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="w-full lg:w-1/2 space-y-6">
              <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-[#E07B00]/10 to-[#FFA500]/10 rounded-full">
                <span className="text-sm font-semibold text-[#E07B00]">
                  Showcase Your Talent
                </span>
              </div>

              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#6A3E2E]">
                Youth{" "}
                <span className="bg-gradient-to-r from-[#6A3E2E] via-[#8B4513] to-[#E07B00] bg-clip-text text-transparent">
                  Gallery
                </span>
              ...
              <div className="space-y-4 bg-gradient-to-br from-[#E07B00]/10 to-[#FFA500]/10 backdrop-blur-sm rounded-2xl p-6 border border-[#E07B00]/20">
                <h3 className="text-xl font-bold text-[#6A3E2E]">How to Participate:</h3>
                <ul className="space-y-2">
                  <li className="flex items-center">
                    <div className="w-2 h-2 bg-gradient-to-r from-[#E07B00] to-[#FFA500] rounded-full mr-3"></div>
                    <span className="text-[#8B4513]">Create your best content - photos, videos, reels</span>
                  </li>
                  <li className="flex items-center">
                    <div className="w-2 h-2 bg-gradient-to-r from-[#E07B00] to-[#FFA500] rounded-full mr-3"></div>
                    <span className="text-[#8B4513]">Email to: YouthGallery@yuvamanthan.org</span>
                  </li>
                  <li className="flex items-center">
                    <div className="w-2 h-2 bg-gradient-to-r from-[#E07B00] to-[#FFA500] rounded-full mr-3"></div>
                    <span className="text-[#8B4513]">Get featured on our platform</span>
                  </li>
                </ul>
              </div>

              <button className="group relative inline-flex items-center justify-center space-x-2 bg-gradient-to-r from-[#8B4513] to-[#E07B00] text-white px-8 py-4 rounded-xl font-bold overflow-hidden hover:shadow-xl transition-all duration-300">
      ...
      {/* Upcoming Events & Blogs Section - Updated */}
      <section className="w-full bg-gradient-to-b from-white to-[#FFF7ED] py-12 md:py-20 lg:py-32">
        <div className="container mx-auto px-4 md:px-8 lg:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div>
              <div className="flex items-center mb-8">
                <div className="p-3 bg-gradient-to-br from-[#8B4513]/10 to-[#C46200]/10 rounded-xl mr-4">
                ...
                {upcomingEvents.map((event, index) => (
                  ...
                  >
                    <div className="flex-shrink-0">
                      <div className="w-16 h-16 bg-gradient-to-br from-[#8B4513]/10 to-[#C46200]/10 rounded-xl flex flex-col items-center justify-center">
                        <span className="text-lg font-bold text-[#8B4513]">{event.date.split(' ')[0]}</span>
                        <span className="text-xs text-[#C46200]">{event.date.split(' ')[1]}</span>
                      </div>
                    </div>
                    <div className="flex-grow">
                      <div className="flex items-center mb-2">
                        {event.icon}
                        <h3 className="text-lg font-semibold text-[#6A3E2E] ml-2">
                          {event.title}
                        </h3>
                      </div>
                      <p className="text-[#8B4513]/80 text-sm mb-2">{event.description}</p>
            ...
            <div>
              <div className="flex items-center mb-8">
                <div className="p-3 bg-gradient-to-br from-[#E07B00]/10 to-[#FFA500]/10 rounded-xl mr-4">
                  <FileText className="w-6 h-6 text-[#E07B00]" />
                </div>
                <h2 className="text-2xl md:text-3xl font-bold text-[#6A3E2E]">
                  Featured Blogs
                </h2>
                ...
                {featuredBlogs.map((blog, index) => (
                  ...
                  >
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        <div className="inline-flex items-center px-2 py-1 bg-gradient-to-r from-[#E07B00]/10 to-[#FFA500]/10 rounded-full mb-2">
                          <span className="text-xs font-semibold text-[#E07B00]">
                            {blog.date}
                          </span>
                        </div>
                        <h3 className="text-xl font-bold text-[#6A3E2E] mb-2">
                          {blog.title}
                        </h3>
                      </div>
                      <div className="text-3xl">📝</div>
                    </div>
                    <p className="text-[#8B4513]/80 text-sm mb-4 line-clamp-2">
                      {blog.excerpt}
                    </p>
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-[#8B4513]/60">{blog.readTime}</span>
                      <button className="flex items-center text-sm font-semibold text-[#E07B00] hover:text-[#FFA500]">
                        Read More
                        <ArrowRight className="w-4 h-4 ml-1" />
                      </button>
                    </div>
              ...
              <button className="w-full mt-6 py-3 bg-gradient-to-r from-[#6A3E2E]/10 to-[#8B4513]/10 text-[#6A3E2E] rounded-xl font-semibold hover:shadow-md transition-all duration-300">
                View All Blogs
              </button>
            </div>
          </div>
      ...
      <section className="w-full bg-gradient-to-b from-[#FFF7ED] to-white py-12 md:py-20 lg:py-32">
        <div className="container mx-auto px-4 md:px-8 lg:px-16">
          <div className="text-center mb-12 lg:mb-16">
            <div className="inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-[#6A3E2E]/10 to-[#8B4513]/10 rounded-2xl mb-4 md:mb-6">
              <MessageSquare className="w-8 h-8 md:w-10 md:h-10 text-[#6A3E2E]" />
            </div>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#6A3E2E] mb-4">
              Frequently Asked{" "}
              <span className="bg-gradient-to-r from-[#6A3E2E] via-[#8B4513] to-[#E07B00] bg-clip-text text-transparent">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {faqs.map((faq, index) => (
              <div
                key={index}
                className="group bg-white rounded-2xl border border-[#6A3E2E]/20 overflow-hidden hover:border-[#6A3E2E]/40 hover:shadow-md transition-all duration-300"
              >
                <button className="w-full px-6 py-4 text-left flex justify-between items-center">
                  <h3 className="text-lg font-semibold text-[#6A3E2E]">
                    {faq.question}
                  </h3>
                  <ChevronRight className="w-5 h-5 text-[#8B4513]/60 group-hover:text-[#6A3E2E] group-hover:rotate-90 transition-all duration-300" />
                </button>
                <div className="px-6 pb-4">
                  <p className="text-[#8B4513]">{faq.answer}</p>
                </div>
              </div>
            ))}
          </div>
